...
public interface OGListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link OGParser#coordinateReference}.
	 * @param ctx the parse tree
	 */
	void enterCoordinateReference(OGParser.CoordinateReferenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link OGParser#coordinateReference}.
	 * @param ctx the parse tree
	 */
	void exitCoordinateReference(OGParser.CoordinateReferenceContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link OGParser#signedAtom}.
	 * @param ctx the parse tree
	 */
	void enterSignedAtom(OGParser.SignedAtomContext ctx);
	/**
	 * Exit a parse tree produced by {@link OGParser#signedAtom}.
	 * @param ctx the parse tree
	 */
	void exitSignedAtom(OGParser.SignedAtomContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link OGParser#numberRefence}.
	 * @param ctx the parse tree
	 */
	void enterNumberRefence(OGParser.NumberRefenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link OGParser#numberRefence}.
	 * @param ctx the parse tree
	 */
	void exitNumberRefence(OGParser.NumberRefenceContext ctx);
	/**
	 * Enter a parse tree produced by {@link OGParser#valueReference}.
	 * @param ctx the parse tree
	 */
	void enterValueReference(OGParser.ValueReferenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link OGParser#valueReference}.
	 * @param ctx the parse tree
	 */
	void exitValueReference(OGParser.ValueReferenceContext ctx);
}