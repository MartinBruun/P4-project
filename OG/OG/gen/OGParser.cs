...
public partial class OGParser : Parser {
	...
	public partial class ProgContext : ProgramContext {
		public MachineStnsContext settings;
		public DrawContext drawFunction;
		public FunctionDclsContext functionsDeclarations;
		public ShapeDclsContext shapeDeclarations;
		[System.Diagnostics.DebuggerNonUserCode] public MachineStnsContext machineStns() {
			return GetRuleContext<MachineStnsContext>(0);
		}
	...
	public ProgramContext program() {
		...
		try {
			...
			{
			State = 114;
			((ProgContext)_localctx).settings = machineStns();
			State = 115;
	...
	public partial class MachineStnsContext : ParserRuleContext {
		public MachineStnsContext(ParserRuleContext parent, int invokingState)
			: base(parent, invokingState)
		{
		}
		public override int RuleIndex { get { return RULE_machineStns; } }
	 
		public MachineStnsContext() { }
		public virtual void CopyFrom(MachineStnsContext context) {
			base.CopyFrom(context);
		}
	}
	public partial class NoMachineSettingsContext : MachineStnsContext {
		public NoMachineSettingsContext(MachineStnsContext context) { CopyFrom(context); }
		[System.Diagnostics.DebuggerNonUserCode]
		public override void EnterRule(IParseTreeListener listener) {
			IOGListener typedListener = listener as IOGListener;
			if (typedListener != null) typedListener.EnterNoMachineSettings(this);
		}
		[System.Diagnostics.DebuggerNonUserCode]
		public override void ExitRule(IParseTreeListener listener) {
			IOGListener typedListener = listener as IOGListener;
			if (typedListener != null) typedListener.ExitNoMachineSettings(this);
		}
		[System.Diagnostics.DebuggerNonUserCode]
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			IOGVisitor<TResult> typedVisitor = visitor as IOGVisitor<TResult>;
			if (typedVisitor != null) return typedVisitor.VisitNoMachineSettings(this);
			else return visitor.VisitChildren(this);
		}
	}
	...
	[RuleVersion(0)]
	public MachineStnsContext machineStns() {
		MachineStnsContext _localctx = new MachineStnsContext(Context, State);
		EnterRule(_localctx, 2, RULE_machineStns);
		try {
			State = 124;
			...
			case Machine:
				...
				break;
			case DrawDCLWord:
				_localctx = new NoMachineSettingsContext(_localctx);
