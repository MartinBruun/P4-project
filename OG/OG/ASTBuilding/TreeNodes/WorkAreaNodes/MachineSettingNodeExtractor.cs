    ...
    public class MachineSettingNodeExtractor : OGBaseVisitor<MachineSettingNode>
    {
        public override MachineSettingNode VisitMachineSettings(OGParser.MachineSettingsContext context)
        {
            if (context.machineModifications.workAreaModifications.workAreaModificationProperties
                .sizeProperty != null)
            {
                var size = VisitSizePrpt(context.machineModifications.workAreaModifications
            ...
            SizePropertyNode s = new SizePropertyNode(
                                                        new NumberNode(0), 
                                                        new NumberNode(100), 
                                                        new NumberNode(0),
                                                        new NumberNode(100)
        ...
        // public override MachineSettingNode VisitMachineSettings(OGParser.MachineSettingsContext context)
        // {
        //     var size = VisitSizePrpt(context.machineModifications.workAreaModifications.workAreaModificationProperties
        //         .sizeProperty);
        //     WorkAreaSettingNode Wsettings = new WorkAreaSettingNode(size);
        //     
