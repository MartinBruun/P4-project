...
public interface mainGrammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link mainGrammarParser#prule}.
	 * @param ctx the parse tree
	 */
	void enterPrule(mainGrammarParser.PruleContext ctx);
	/**
	 * Exit a parse tree produced by {@link mainGrammarParser#prule}.
	 * @param ctx the parse tree
	 */
	void exitPrule(mainGrammarParser.PruleContext ctx);
}